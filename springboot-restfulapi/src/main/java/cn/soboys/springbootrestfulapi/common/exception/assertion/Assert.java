...
import cn.soboys.springbootrestfulapi.common.exception.WrapMessageException;
 ...
 * default 修饰表示接口默认方法 和普通方法一样 不能是抽象的，因为它们已经具有默认的实现。
 * @author xub
